# SwiftTesting 1.0 Cheat Sheet

![SwiftTesting](./assets/swift-ui-logo.png)


### Table of Contents
- [SwiftTesting Cheat Sheet](#SwiftTesting-cheat-sheet)
    - [Table of Contents](#table-of-contents)
- [Resource](#resource)
- [UIKit equivalent in SwiftTesting](#uikit-equivalent-in-SwiftTesting)
- [View](#view)
    - [Text](#text)
    - [Label](#label)
...
- [Work with UIKit](#work-with-uikit)
    ...
    - [Use UIKit and SwiftTesting Views Together](#use-uikit-and-SwiftTesting-views-together)

# Resource
- [SwiftTesting Tutorials (Official)](https://developer.apple.com/tutorials/SwiftTesting/creating-and-combining-views)
- [Introducing SwiftTesting: Building Your First App (Official)](https://developer.apple.com/videos/play/wwdc2019/204/)
- [SwiftTesting: Getting Started Raywenderlich](https://www.raywenderlich.com/3715234-SwiftTesting-getting-started)
- [SwiftTesting Essentials (Official)](https://developer.apple.com/videos/play/wwdc2019/216)
- [SwiftTesting - How to setup a project](https://medium.com/@martinlasek/SwiftTesting-getting-started-372389fff423)
- [About SwiftTesting](https://github.com/Juanpe/About-SwiftTesting)


# UIKit equivalent in SwiftTesting
| UIKit | [SwiftTesting](https://developer.apple.com/xcode/SwiftTesting/) |
| ----------- | ----------- |
...
### Label
Labels are a much-needed addition in the latest SwiftTesting iteration. They let you set icons alongside text with the following line of code.

``` swift
Label("SwiftTesting CheatSheet 2.0", systemImage: "up.icloud")
```
...
### TextEditor
Multi-line scrollable UITextViews natively in SwiftTesting
...
### Map
MapKit natively in SwiftTesting
...
### LazyVGrid
A containers for grid-based layouts that let you set child views vertically in LazyVGrid. Each element of a SwiftTesting grid is a GridItem. We can set the alignments, spacing, and size of the GridItem
...
onChange is a new view modifier that’s available across all SwiftTesting views. It lets you listen to state changes and perform actions on a view accordingly.
...
>  It's possible to work with UIKit components from SwiftTesting or call SwiftTesting views as View Controllers from UIKit. 

Let's say you have a View Controller named SuperVillainViewController and want to call it from a SwiftTesting view, to do that ViewController needs to implement UIViewControllerRepresentable:
...
```
### Use UIKit and SwiftTesting Views Together

> To use UIView subclasses from within SwiftTesting, you wrap the other view in a SwiftTesting view that conforms to the UIViewRepresentable protocol. ([Reference](https://developer.apple.com/tutorials/SwiftTesting/creating-and-combining-views#use-uikit-and-SwiftTesting-views-together))
